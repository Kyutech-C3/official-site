<template>
  <div>
    ...
    >
      ...
      <textarea v-model="description" placeholder="内容" class="description" cols="30" rows="5" required></textarea>
      <br />
      <p>開催日時を教えてください</p>
      <input type="date" name="num01" autocomplete="off" v-model="date" required>
      <br />
      <p>画像を挿入してください</p>
